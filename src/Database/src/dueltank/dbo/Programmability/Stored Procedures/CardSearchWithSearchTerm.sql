CREATE PROCEDURE [dbo].[CardSearchWithSearchTerm] 
	@limitId bigint = 0,
	@categoryId bigint = 0,
...
BEGIN
	...
	-- To perform wildcard searches via full text search
	...
	INNER JOIN
		CONTAINSTABLE ([dbo].[Card], ([Name], [Description]), @searchTerm) AS KEY_TBL 
			ON ([c].[Id] = KEY_TBL.[KEY])
	WHERE
