...
namespace dueltank.application.unit.tests.HelperTests.MonsterCardHelperTests
{
    ...
    public class DeckCardDetailMapToMonsterCardTests
    {
        [Test]
        public void Given_A_DeckCardDetail_Should_Map_To_Monster_Card()
        {
            // Arrange
            var cardSearch = new DeckCardDetail
            {
                CategoryId = 23424,
                Category = "Monster",
        ...
        [Test]
        public void Given_A_DeckCardDetail_Should_Map_To_Monster_SubCategories_To_CardSubCategory()
        {
            // Arrange
