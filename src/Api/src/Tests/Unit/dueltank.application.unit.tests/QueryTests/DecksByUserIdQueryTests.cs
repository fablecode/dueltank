...
{
    [TestFixture]
    public class DecksByUserIdQueryTests
    {
        private IDeckService _deckService;
        private DecksByUserIdQueryHandler _sut;
        ...
        public void SetUp()
        {
            ...
            _sut = new DecksByUserIdQueryHandler(_deckService);
        }
        ...
        {
            // Arrange
            var query = new DecksByUserIdQuery{ UserId = Guid.NewGuid().ToString() };

            _deckService.Search(Arg.Any<DeckSearchByUserIdCriteria>()).Returns(new DeckSearchResult { Decks = new List<DeckDetail>()});
